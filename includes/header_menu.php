<!--Navigation start-->
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:#8c0402">
            <div class="container">
                    <a href="index.php" class="navbar-brand" style="font-family: 'Reggae One'">Game ZoneX</a>
                       ...
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   <a href="products.php#watch" class="dropdown-item">Gaming Casing</a>
                                   <a href="products.php#shirt" class="dropdown-item">Monitors</a>
                                   <a href="products.php#shoes" class="dropdown-item">Graphic Cards </a>
                                   <a href="products.php#headphones" class="dropdown-item">Console & Handheld Gaming</a>
                               </div>
          ...
          <div class="modal-content"style="background-color:rgba(255,255,255,0.95)">
            ...
            <div class="modal-body">
              <form action="login_script.php" method="post">
                ...
                <button type="submit" class="btn btn-secondary btn-block" name="Submit" style="background-color:#8c0402">Login</button>
              </form>
              <a style="color:#8c0402" href="http://">Forgot password! </a>
            </div>
            <div class="modal-footer">
              <p class="mr-auto">New User! <a href="#signup" data-toggle="modal" data-dismiss="modal" style="color:#8c0402" >Sign Up</a></p>
              <button type="button" class="btn btn-secondary" data-dismiss="modal" style="background-color:#8c0402" >Close</button>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="modal-content" style="background-color:rgba(255,255,255,0.95)">
            ...
            <div class="modal-body">
              <form action="signup_script.php" method="post">
                ...
                <button type="submit"style="background-color:#8c0402" class="btn btn-primary btn-block" name="Submit" >Sign Up</button>
              </form>
            </div>
            <div class="modal-footer">
              <p class="mr-auto">Already Registered?<a href="#login"  data-toggle="modal" data-dismiss="modal" style="color:#8c0402">Login</a></p>
              <button type="button" class="btn btn-secondary" data-dismiss="modal " style="background-color:#8c0402" >Close</button>
            </div>
          </div>
        </div>
