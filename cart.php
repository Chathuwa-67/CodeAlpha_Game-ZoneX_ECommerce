...
while ($row = mysqli_fetch_array($result)) {
    ...
    $id = rtrim($id, ", ");
    echo "<tr><td></td><td>Total</td><td>Rs " . $sum . "</td><td><a href='success.php' class='btn btn-danger'>Confirm Order</a></td></tr>";
    ?>
                            </tbody>
                            <?php
} else {
    echo "<div> <img src='./img/cart.png' class='image-fluid' height='150' width='150'></div><br/>";
